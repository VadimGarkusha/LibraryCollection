<%--VADYM HARKUSHA 300909484--%><%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddBookControl.ascx.cs" Inherits="AddBook" %>
        ...
        <br />
        <asp:TextBox ID="txtAuthor" runat="server"></asp:TextBox><%--VADYM HARKUSHA 300909484--%>
